...
MODEL                   = Mechanik_FensterSchlitten
MODULES                 = rt_logging_simtarget.c Mechanik_FensterSchlitten.c Mechanik_FensterSchlitten_capi.c Mechanik_FensterSchlitten_data.c Mechanik_FensterSchlitten_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = Mechanik_FensterSchlitten
MAKEFILE                = Mechanik_FensterSchlitten.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2021a
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2021a
START_DIR               = /home/johannes/Workspaces/Matlab/Fensterheber
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 4
COMPUTER                = GLNXA64
BUILDARGS               =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/usr/local/MATLAB/R2021a" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/Mechanik_FensterSchlitten \
